    ...
    <div class="row">
        <section class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ul class="list-unstyled">
                        ...
                        <li><s:a action="checkbox"> Rappel fin de prêt : </s:a> <s:if test="#user.reminder == true">Activé</s:if>
            ...
            <div>
                ...
                <button><s:a action="extendborrow"> Prolonger un prêt</s:a> </button>
            </div>
            ...
            <table class="table table-bordered table-striped table-condensed">
                ...
                <tr>
                    <td><s:a action="reservation"><s:param name="id" value="res_Id"/><s:property value="book.title"/></s:a></td>
                    <td><s:property value="index"/></td>
                    </s:iterator>
                </tbody>
            </table>
                <button><s:a action="cancel"> Annuler une réservation</s:a> </button>
            </div>
